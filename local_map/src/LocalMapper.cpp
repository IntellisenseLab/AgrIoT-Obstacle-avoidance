...
#include <local_map/LocalMapper.h>
...
LocalMapper ::LocalMapper () : mTf2Buffer(), mTf2Listener(mTf2Buffer)
{
...
void LocalMapper::get_certainity_grid()
{
	int p = 0;
...
void LocalMapper::get_vector_magnitude()
{
...
void LocalMapper::build_polar_histogram()
{
...
void LocalMapper ::buildPolarHistogram()
{
